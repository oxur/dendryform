...
# Variables
PROJECT_NAME := Dendryform
CODE_NAME := dendryform
BIN_DIR := ./bin
MODE := debug
TARGET := ./target/$(MODE)
...
remotes:
	@echo "$(BLUE)Setting git remotes...$(RESET)"
	@-git remote add macpro ssh://macpro.local:23231/oxur/dendryform.git
	@-git remote add github git@github.com:oxur/dendryform.git
	@-git remote add codeberg ssh://git@codeberg.org/oxur/dendryform.git
